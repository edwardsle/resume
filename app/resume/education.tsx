...
export default function Education() {
  return (
    <section className="w-full p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-10 gap-x-6 mt-14 sm:mt-20">
        {/* ===== UCI ===== */}
        <div className="group relative w-full">
          <div className="w-full flex justify-center">
            <div className="relative">
              <img
                src="/img/uci.png"
                className="shadow-xl rounded-full align-middle border-none absolute -m-10 -ml-12 sm:-m-16 sm:-ml-20 lg:-ml-16 max-w-[100px] sm:max-w-[150px] z-40"
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="relative rounded-xl bg-white group-hover:bg-gradient-to-b group-hover:from-brand-50 px-6">
              <div className="flex flex-wrap justify-center">
                <div className="w-full text-center mt-12 sm:mt-20">
              ...
              <div className="text-center mt-2">
                <h3 className="text-lg sm:text-2xl text-slate-700 font-bold leading-normal mb-1">
