...
const listJobs = [
  {
    ...
    tags: [
      "Yocto", "U-boot", "Cross-Compilation", 
      "Kernel", "DTS/DTB", "Linux BSP", "Device Tree", "Real-Time Scheduling", 
      "Cyclictest", "Preempt-RT", "FPGA",
      "Nvidia Jetson Xavier", "Nvidia Jetson Orin", "Jetson BSP", 
      "Gstreamer", "RTSP/RTP", "WebRTC", "C/C++", "Python", "BASH Script",
      "DeepStream", "CUDA", "OpenCV", "TensorRT", "YOLO", "",
  ...
  },
  {
    ...
    tags: [
      ...
      "CCU Control", "Teleprompter Control", "Transcoding Automation", "Playbox",
      "VMix", "EDIUS", "Caddy", "NGINX",
    ],
    responsibility: [
